...
def update_verbali(file_content):
    ...
    try:
        ...
        # Questa parte dei verbali esterni pre-candidatura è inutilizzata al momento, perchè ho messo i nomi delle aziende, e quindi l'inserimento automatico non funziona
